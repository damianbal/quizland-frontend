...
export default {
  ...
  methods: {
    ...
    resultMessage() {
      if (this.num_correct == this.questions.length)
        return "Wow you got all them right :D";
      else if (
        this.num_correct >= this.questions.length / 2 &&
        this.num_correct < this.questions.length
      )
        return (
          "You did good, but not best, you got " +
          this.num_correct +
          " out of " +
        ...
        return (
          "Well you did not so good you got " +
          this.num_correct +
          " out of " +
          this.questions.length
        );
